//
//  MultiRowsPagingFlowLayout.swift
//  Playlist
//
...
class MultiRowsPagingFlowLayout: UICollectionViewFlowLayout {
    ...
    override var collectionViewContentSize : CGSize {
        ...
        if self.scrollDirection == UICollectionViewScrollDirection.horizontal {
            ...
            let columnCount = 1// Int((canvasSize.width - self.itemSize.width) / (self.itemSize.width + self.minimumLineSpacing) + 1)
